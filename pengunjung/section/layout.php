...
<header id="header">
    <div class="container">
        ...
        <div id="logo" class="pull-left">
            <h1><a href="#intro" class="scrollto"> <b style="font-family:rockwell;font-size:50px"> BKSDA YOGYAKARTA</b> </a></h1>
        ...
        <nav id="nav-menu-container">
            <ul class="nav-menu">
                <li class="menu-active"><a href="#intro" style="font-size:20px">Home</a></li>
                <li><a href="#about" style="font-size:20px">About Us</a></li>
                <li><a href="#gallery" style="font-size:20px">Gallery</a></li>
                <li><a href="#contact" style="font-size:20px">Contact Us</a></li>
                <li><button class="btn btn-warning" data-toggle="modal" data-target="#modal-form-login" style="color:white;font-size:20px"></span>&nbsp LOGIN  &nbsp</button></li>
            </ul>
